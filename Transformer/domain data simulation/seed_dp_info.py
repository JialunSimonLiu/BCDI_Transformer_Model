...
N_maxima = 150 # Fixed number of DP maxima for the batch training
...
for crystal_index in range(N):
    ...
    seeds = np.round(generate_circular_seeds(num_seeds, grid_size // 2),4)
...
def save_data(crystals, file_path='data.h5'):
