...
# A test for the original transformer model to reconstruct a smiley face:
# 1. Full information of the ground truth; 2. removed 0 intensities; 3. extract 2*2 or 3*3 local maxima
...
def create_smiley_face_data(img_size, num_samples):
    ...
    eyes = [(5, 6), (5, 7), (5, 13), (5, 14)]  # Two eyes
